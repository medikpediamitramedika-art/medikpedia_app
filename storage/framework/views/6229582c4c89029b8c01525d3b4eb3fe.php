...
<?php $__env->startSection('page-title', 'Import Data Obat'); ?>
...
<div class="info-box">
    ...
    <ol>
        ...
        <li>Isi data produk di sheet <strong>"Data Obat"</strong></li>
        <li>Upload langsung file <strong>.xls</strong> tersebut, <strong>atau</strong> simpan sebagai <strong>CSV</strong> lalu upload</li>
        <li>Hanya produk dengan GOLONGAN <strong>KERAS</strong> yang akan diimport ke sini</li>
    </ol>
    <p class="success-note">
        ✅ Format kolom: <strong>PABRIK | NAMA PRODUK | RETAIL | KOMPOSISI | INDIKASI | GOLONGAN</strong>
    </p>
</div>
...
<div class="form-card" style="margin-bottom: 1.5rem;">
    ...
    <div class="form-body">
        <div style="display: flex; align-items: center; gap: 1rem; flex-wrap: wrap; margin-bottom: 1rem;">
            <a href="<?php echo e(route('admin.prescriptions.import.template')); ?>" class="btn-save" style="background: #10b981; text-decoration: none;">
        ...
        <div style="margin-top: 0.75rem; padding: 0.75rem; background: #fef3c7; border-radius: 0.5rem; border: 1px solid #fde68a;">
            <p style="font-size: 0.78rem; color: #92400e; margin: 0; line-height: 1.6;">
                ...
                <strong>Catatan:</strong> Hanya baris dengan GOLONGAN = <strong>KERAS</strong> yang akan diimport ke halaman ini.
                Baris BEBAS akan dilewati. Untuk import semua golongan, gunakan halaman <a href="<?php echo e(route('admin.medicines.import')); ?>" style="color:#1E88E5;">Import Obat Biasa</a>.
            </p>
        </div>
    </div>
</div>
...
<div class="form-card">
    ...
    <div class="form-body">
        ...
        <div id="dropZone" class="upload-zone" onclick="document.getElementById('fileInput').click()"
            ...
            <small>Format: CSV, XLS — Maks. 5MB</small>
    ...
    <div class="form-footer">
        <form action="<?php echo e(route('admin.prescriptions.import.process')); ?>" method="POST" enctype="multipart/form-data" id="submitForm" style="display: none;">
            <?php echo csrf_field(); ?>
        ...
        <a href="<?php echo e(route('admin.prescriptions.index')); ?>" class="btn-cancel">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u656662250/domains/medikpedia.com/public_html/resources/views/admin/grosir/import.blade.php ENDPATH**/ ?>