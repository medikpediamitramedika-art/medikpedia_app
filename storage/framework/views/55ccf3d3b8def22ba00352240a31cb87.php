...
<?php $__env->startSection('title', $medicine->nama_obat . ' - Medikpedia'); ?>
...
<div class="detail-page-header">
    <div class="container">
        <div class="breadcrumb-custom">
            ...
            <span>/</span>
            <a href="<?php echo e(route('products')); ?>">Produk</a>
            <span>/</span>
            <span class="current"><?php echo e(Str::limit($medicine->nama_obat, 30)); ?></span>
        </div>
        <h1><?php echo e($medicine->nama_obat); ?></h1>
        <p><i class="fa-solid fa-building fa-sm"></i> <?php echo e($medicine->kategori); ?></p>
    </div>
</div>
...
<div class="detail-wrapper">
    <div class="detail-container">
        <div class="detail-grid">
            ...
            <div class="detail-image-col">
                <div class="detail-image">
                    <?php if($medicine->gambar): ?>
                        <img src="<?php echo e(asset('public/storage/' . $medicine->gambar)); ?>" alt="<?php echo e($medicine->nama_obat); ?>">
                    <?php else: ?>
            ...
            <div class="detail-info">
                <span class="detail-category"><?php echo e($medicine->kategori); ?></span>
                <h1><?php echo e($medicine->nama_obat); ?></h1>

                <div class="price-section">
                    <div class="price-label">Harga Satuan</div>
                    <div class="price"><?php echo e($medicine->getFormattedPrice()); ?></div>
                </div>

                <div class="stock-info">
                    <div class="stock-item">
                        <div class="stock-item-label">Stok Tersedia</div>
                        <div class="stock-item-value"><?php echo e($medicine->stok); ?></div>
                    </div>
                    <div class="stock-item">
                        <div class="stock-item-label">Status</div>
                        <div class="stock-item-value" style="font-size:1rem;">
                            <?php if($medicine->isAvailable()): ?>
                ...
                <div class="description-section">
                    ...
                    <p><?php echo e($medicine->deskripsi); ?></p>
                </div>
                <?php endif; ?>
                ...
                <div style="background:#f9fafb;border-radius:12px;padding:1.25rem;margin:1.25rem 0;border:1px solid #e5e7eb;">
                    ...
                    <div style="margin-bottom:0.85rem;">
                        ...
                        <div style="display:flex;align-items:center;gap:0.5rem;flex-wrap:wrap;">
                            ...
                            <input type="number" id="qtyInput" value="1" min="1" max="<?php echo e($medicine->stok); ?>"
                                ...
                                oninput="updateTotal()">
                            <button type="button" onclick="changeQty(1)" style="width:34px;height:34px;border:1px solid #d1d5db;border-radius:8px;background:white;font-size:1rem;cursor:pointer;font-weight:700;color:#374151;flex-shrink:0;">+</button>
                            <span style="font-size:0.78rem;color:#9ca3af;">Stok: <?php echo e($medicine->stok); ?></span>
                        </div>
                    </div>
                    ...
                    <div style="margin-bottom:0.85rem;padding:0.65rem 1rem;background:#e3f2fd;border-radius:8px;display:flex;justify-content:space-between;align-items:center;">
                        ...
                        <span id="totalHarga" style="font-size:1rem;font-weight:800;color:#1565C0;"><?php echo e($medicine->getFormattedPrice()); ?></span>
                    </div>
                ...
                <a href="<?php echo e(route('products')); ?>" style="display:flex;align-items:center;justify-content:center;gap:0.5rem;padding:0.65rem;border:1.5px solid #e5e7eb;border-radius:10px;color:#6b7280;text-decoration:none;font-weight:600;font-size:0.875rem;transition:all 0.2s;">
    ...
    <div class="related-section">
        <h2><i class="fa-solid fa-pills"></i> Produk Serupa — <?php echo e($medicine->kategori); ?></h2>
                ...
                <a href="<?php echo e(route('medicines.show', $related->id)); ?>" class="related-card">
                    <div class="related-image">
                        <?php if($related->gambar): ?>
                            <img src="<?php echo e(asset('storage/' . $related->gambar)); ?>" alt="<?php echo e($related->nama_obat); ?>">
                        <?php else: ?>
                    ...
                    <div class="related-body">
                        ...
                        <div class="related-price"><?php echo e($related->getFormattedPrice()); ?></div>
                    </div>
                </a>
...
<script>
    const hargaSatuan = <?php echo e($medicine->harga); ?>;
    const stokMax     = <?php echo e($medicine->stok); ?>;
    const namaObat    = <?php echo json_encode($medicine->nama_obat, 15, 512) ?>;
    const kategori    = <?php echo json_encode($medicine->kategori, 15, 512) ?>;
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u656662250/domains/medikpedia.com/public_html/resources/views/medicines/detail.blade.php ENDPATH**/ ?>