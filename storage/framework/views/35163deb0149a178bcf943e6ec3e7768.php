...
<?php $__env->startSection('title', 'Manajemen Produk - Admin Medikpedia'); ?>
...
<div class="page-header">
    ...
    <div class="page-header-actions">
        <a href="<?php echo e(route('admin.prescriptions.import')); ?>" class="btn-icon btn-icon-outline">
            <i class="fa-solid fa-file-import"></i> Import Excel
        </a>
        <a href="<?php echo e(route('admin.prescriptions.create')); ?>" class="btn-icon btn-icon-primary">
...
<div class="search-card">
    <form method="GET" action="<?php echo e(route('admin.prescriptions.index')); ?>">
        <div class="search-row">
            ...
            <div class="search-actions">
                ...
                <?php if($search || $kategori): ?>
                    <a href="<?php echo e(route('admin.prescriptions.index')); ?>" class="btn-reset">
                ...
                <tr>
                    ...
                    <td>
                        <div class="action-wrap">
                            <a href="<?php echo e(route('admin.prescriptions.edit', $medicine->id)); ?>" class="btn-edit">
                                <i class="fa-solid fa-pen"></i> Edit
                            </a>
                            <form action="<?php echo e(route('admin.prescriptions.destroy', $medicine->id)); ?>" method="POST"
...
<?php else: ?>
    <div class="empty-state">
        <?php if($search || $kategori): ?>
            ...
            <a href="<?php echo e(route('admin.prescriptions.index')); ?>" class="btn-icon btn-icon-outline">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u656662250/domains/medikpedia.com/public_html/resources/views/admin/grosir/index.blade.php ENDPATH**/ ?>