...
<div class="products-header">
    <div class="container">
        ...
        <h1><i class="fa-solid fa-pills"></i> Produk</h1>
...
<div class="products-main">
    <div class="container">
        ...
        <form method="GET" action="{{ route('prescriptions') }}" class="filter-bar">
                ...
                @foreach($medicines as $medicine)
                    <div class="medicine-card">
                        ...
                        <div class="medicine-body">
                            ...
                            @if($medicine->stok > 0)
                            <button class="btn-cart" onclick="addToCart({{ $medicine->id }}, '{{ addslashes($medicine->nama_obat) }}', {{ $medicine->harga }}, '{{ $medicine->gambar ? asset('storage/app/public/'.$medicine->gambar) : '' }}', this)">
