    ...
    <form action="{{ route('admin.news.store') }}" method="POST" enctype="multipart/form-data" id="newsForm">
        ...
        <div style="margin-bottom: 1.5rem;">
            ...
            >
                ...
                <option value="diskon"        {{ old('tipe') === 'diskon'        ? 'selected' : '' }}>🏷️ Diskon</option>
                <option value="flash_sale"    {{ old('tipe') === 'flash_sale'    ? 'selected' : '' }}>⚡ Flash Sale</option>
                <option value="bundling"      {{ old('tipe') === 'bundling'      ? 'selected' : '' }}>📦 Bundling</option>
                <option value="promo_spesial" {{ old('tipe') === 'promo_spesial' ? 'selected' : '' }}>🎁 Promo Spesial</option>
            </select>
            @error('tipe')
                <p style="color: #ef4444; font-size: 0.875rem; margin-top: 0.25rem;">{{ $message }}</p>
            @enderror
        ...
        <div style="margin-bottom: 1.5rem;">
            <label for="file" style="display: block; margin-bottom: 0.5rem; font-weight: 600;">
                ...
                <span style="color: #6b7280; font-weight: 400;">(Maks. 20MB)</span>
            </label>
            ...
            " id="dropZone">
                ...
                <div id="fileLabel" style="pointer-events: none;">
                    ...
                    <p style="margin: 0;">Drag & drop file media di sini</p>
        ...
        <div style="margin-bottom: 1.5rem;">
            <label for="thumbnail" style="display: block; margin-bottom: 0.5rem; font-weight: 600;">
                Thumbnail (Gambar Preview) <span style="color: #ef4444;">*</span> <span style="color: #6b7280; font-weight: 400;">(Maks. 5MB, JPG/PNG/GIF)</span>
            </label>
            <div style="
                border: 2px dashed #d1d5db;
                border-radius: 0.375rem;
            ...
            " id="thumbnailDropZone">
                ...
                <div id="thumbnailLabel" style="pointer-events: none;">
                    ...
                    <p style="margin: 0;">Drag & drop thumbnail di sini</p>
                    <p style="color: #6b7280; font-size: 0.875rem; margin-top: 0.5rem;">atau klik untuk memilih file</p>
                </div>
