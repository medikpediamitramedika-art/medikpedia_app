...
<div style="display:flex;align-items:center;gap:0.5rem;font-size:0.82rem;color:#9ca3af;margin-bottom:1.25rem;">
    <a href="{{ route('admin.prescriptions.index') }}" style="color:#1E88E5;text-decoration:none;font-weight:600;">
...
<form action="{{ route('admin.prescriptions.update', $medicine->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
