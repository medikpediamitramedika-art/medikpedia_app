...
@section('title', 'Edit Produk Resep - Admin Medikpedia')
...
<div style="display:flex;align-items:center;gap:0.5rem;font-size:0.82rem;color:#9ca3af;margin-bottom:1.25rem;">
    <a href="{{ route('admin.prescriptions.products.index') }}" style="color:#1E88E5;text-decoration:none;font-weight:600;">
...
<form action="{{ route('admin.prescriptions.products.update', $medicine->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="two-col-layout">
        ...
        <div class="form-card">
            ...
            <div class="form-body" style="display:flex;flex-direction:column;gap:1rem;">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="number" name="harga" class="form-input {{ $errors->has('harga') ? 'is-invalid' : '' }}" placeholder="5000" step="1" min="0" value="{{ old('harga', $medicine->harga) }}" required>
                        @error('harga')
                            <div class="form-error"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="komposisi"
                           ...
                           value="{{ old('komposisi', explode(' | ', $medicine->deskripsi)[0] ?? '') }}" required>
                    @error('komposisi')
                        <div class="form-error"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="indikasi"
                           ...
                           value="{{ old('indikasi', explode(' | ', $medicine->deskripsi)[1] ?? '') }}" required>
                    @error('indikasi')
                        <div class="form-error"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="golongan"
                        ...
                        <option value="BEBAS" {{ old('golongan', $medicine->is_resep ? 'KERAS' : 'BEBAS') == 'BEBAS' ? 'selected' : '' }}>BEBAS</option>
                        <option value="KERAS" {{ old('golongan', $medicine->is_resep ? 'KERAS' : 'BEBAS') == 'KERAS' ? 'selected' : '' }}>KERAS</option>
                    </select>
                    @error('golongan')
                        <div class="form-error"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</div>
                    @enderror
            ...
            <div class="form-footer">
                ...
                <a href="{{ route('admin.prescriptions.products.index') }}" class="btn-cancel">
        ...
        <div class="form-card">
            ...
            <div class="form-body">
                @if($medicine->gambar)
                    ...
                    <div style="font-size:0.75rem;color:#6b7280;margin-bottom:0.75rem;" id="replaceHint">Upload foto baru untuk mengganti</div>
                @endif
