...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Medikpedia - Apotik Online'); ?></title>
    ...
    <nav class="navbar">
        <div class="navbar-container">
            <a href="<?php echo e(route('home')); ?>" class="navbar-brand">
                <img src="<?php echo e(asset('logo2.png')); ?>" alt="Medikpedia">
            </a>
            ...
            <ul class="navbar-menu" id="navbarMenu">
                ...
                <li><a href="<?php echo e(route('products')); ?>"><i class="fa-solid fa-pills"></i> Produk OTC</a></li>
                <li>
                    <?php if(auth()->guard()->check()): ?>
                        <?php if(auth()->user()->isUser()): ?>
                            <a href="<?php echo e(route('prescriptions')); ?>" style="color:#7CB342;font-weight:700;">
                ...
                <li><a href="<?php echo e(route('activities.index')); ?>"><i class="fa-solid fa-camera"></i> Aktivitas</a></li>
                <li><a href="<?php echo e(route('farmakologi')); ?>"><i class="fa-solid fa-book-medical"></i> Farmakologi</a></li>
                ...
                <?php else: ?>
                    <li class="admin-login-item">
                        <a href="<?php echo e(route('login')); ?>" title="Admin Login"><i class="fa-solid fa-user-shield"></i></a>
                    </li>
                <?php endif; ?>
            </ul>

            
            <button class="cart-nav-btn" id="cartNavBtn" onclick="window.location.href='<?php echo e(route('products')); ?>#keranjang'" title="Keranjang Belanja" style="display:none;">
        ...
        <div class="container">
            <div class="footer-content">
                ...
                <div>
                    <h3>Informasi</h3>
                    <ul>
                        <li><a href="<?php echo e(route('about')); ?>"><i class="fa-solid fa-building fa-fw" style="margin-right:0.5rem;color:#7CB342;"></i>Tentang Kami</a></li>
            ...
            <div class="float-item">
                ...
                <a href="https://dermilosofi.site" target="_blank" class="float-btn"
                   style="background:#fff;box-shadow:0 4px 16px rgba(0,0,0,0.2);overflow:hidden;">
                    <img src="<?php echo e(asset('logodermilosofi.site.jpeg')); ?>" alt="Dermilosofi" style="width:100%;height:100%;object-fit:cover;border-radius:50%;">
                </a>
            </div>
            <!-- Tokopedia -->
            <div class="float-item">
...
<?php /**PATH /home/u656662250/domains/medikpedia.com/public_html/resources/views/layouts/frontend.blade.php ENDPATH**/ ?>