<?php $__env->startSection('title', 'Beranda - Medikpedia'); ?>
        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-6 hero-content">
                ...
                <div class="hero-mobile-image">
                    <img src="<?php echo e(asset('baru.jpeg')); ?>" alt="Medikpedia Background">
                </div>
                ...
                <div class="hero-buttons">
                    <a href="<?php echo e(route('products')); ?>" class="btn-hero-primary"><i class="fa-solid fa-pills"></i> Lihat Produk</a>
                    <a href="<?php echo e(route('news.index')); ?>" class="btn-hero-outline"><i class="fa-solid fa-tag"></i> Produk Promo</a>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="hero-visual">
                    ...
                    <div class="main-hero-image" id="main-hero-bg">
                        <img id="heroMainImg" src="<?php echo e(asset('page1.jpeg')); ?>" alt="Medikpedia">
                    ...
                    <div class="small-photos">
                        <div class="small-photo small-photo-1 thumb-active" onclick="goToSlide(0)">
                            <img src="<?php echo e(asset('page1.jpeg')); ?>" alt="Page 1">
                            <div class="thumb-overlay"></div>
                        </div>
                        <div class="small-photo small-photo-2" onclick="goToSlide(1)">
                            <img src="<?php echo e(asset('page2.jpeg')); ?>" alt="Page 2">
                            <div class="thumb-overlay"></div>
                        </div>
                        <div class="small-photo small-photo-3" onclick="goToSlide(2)">
                            <img src="<?php echo e(asset('page3.jpeg')); ?>" alt="Page 3">
                            <div class="thumb-overlay"></div>
                        </div>
                    </div>
...
<script>
const heroImages = [
    '<?php echo e(asset("page1.jpeg")); ?>',
    '<?php echo e(asset("page2.jpeg")); ?>',
    '<?php echo e(asset("page3.jpeg")); ?>',
    '<?php echo e(asset("page4.jpeg")); ?>',
    '<?php echo e(asset("page5.jpeg")); ?>',
    '<?php echo e(asset("page6.jpeg")); ?>',
];
            ...
            <div class="col-lg-6">
                <div class="about-visual">
                    <div class="about-image-main">
                        <img src="<?php echo e(asset('logo1.png')); ?>" alt="Medikpedia Distributor">
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u656662250/domains/medikpedia.com/public_html/resources/views/home.blade.php ENDPATH**/ ?>